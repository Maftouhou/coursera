(function($) {
    ...
    function getOneNl(nl, idNl) {
        return (
            '<div class="ftven_formabo_content_2NL">' +
        ...
        if (2 <= nbNewsletters) {
            ...
            content =
                '<div id="ftven_formabo_main_content">' +
                    '<form id="ftven_formabo_form">' + getOneNl(nl1, 1) +
                        '<hr class="ftven_formabo_h_separator">'+ getOneNl(nl2, 2) +
                        '<div class="ftven_formabo_email_bloc_submit2NL">' + getSubmitButton() + 
                        '</div>' +
                    '</form>' +
                '</div>';
